  ...
  <div class="max-w-4xl mx-auto px-4 md:px-6 py-8 md:py-12 relative">
    ...
    <div class="flex items-center gap-4 md:gap-6 mb-8">
      <button 
        ...
        class="w-12 h-12 md:w-14 md:h-14 flex items-center justify-center rounded-xl bg-[#8C52FF] border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all group"
      >
